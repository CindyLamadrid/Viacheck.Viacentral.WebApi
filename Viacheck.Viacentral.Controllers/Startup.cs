...
namespace Viacheck.Viacentral.Controllers
{
    public class Startup
    {
        ...
        {
            string originHost = Configuration.GetSection("Settings:HostFromAllowCORS").Value;
            ...
            services.AddScoped<IViamLogger, ViamLogger>();
